...
@section('pageTitle', 'Footer Portion 1 Socials')
...
{{-- Notification --}}
    ...
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <h4 class="card-title" style="text-align: center;">Update A Footer Portion 1 Socials </h4>

            <form class="form-horizontal" method="post"  action="{{ route('footer.portion1SocialsUpdate') }}"  onsubmit="return confirm('Do you really want to proceed?');">
              {{method_field('put')}}
              {{ csrf_field() }}
                                          ...
                                          <tbody>
                                            ...
                                            @foreach ($footerportion1socialsData as $footerportion1social)
                                                <tr>
                                                  ...
                                                  <td>
                                                    <input  class='form-control' type='number' name='socialMediaId[]'  value='{{ $footerportion1social->socialMediaId}}'  readonly multiple hidden>
                                                    <input  class='form-control' type='text'   value='{{ title_case($footerportion1social->socialMedia)}}' readonly multiple >
...
<script type="text/javascript">
    ...
    window.onload = function() {
      @foreach ($footerportion1socialsData as $footerportion1socials)
        socliaMediaList.push({{ $footerportion1socials->socialMediaId}});
      @endforeach
