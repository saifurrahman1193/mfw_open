...
@section('pageTitle', 'Edit Generic Pack Sizes')
  ...
  fieldset{
   ...
   padding: 8px;
	...
	{{-- <div class="container"> --}}
		...
		<div class="card-body">
        <h4 class="card-title" style="text-align: center;">Edit Generic Brand Pack Size & Price</h4>
	        ...
	        <div class="col-md-12 col-md-offset-2">
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <form class="form-horizontal" method="POST"  enctype="multipart/form-data" action="{{ route('generic.pack.sizes.update', $genericpacksizesData->genericPackSizeId) }}"  onsubmit="return confirm('Do you really want to proceed?');"   >
			                {{method_field('put')}}
	                          {{ csrf_field() }}
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="genericId" id="genericId"  required>
				                                      <option value="{{ $genericpacksizesData->genericId }}">{{ $genericpacksizesData->genericName }}</option>
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="genericBrandId" id="genericBrandId" data-genericcompany=""  data-dosageform=""  required>
				                                      <option value="{{ $genericpacksizesData->genericBrandId }}">{{ $genericpacksizesData->genericBrand }}</option>
			                        	...
			                        	<div class="row">
			                        		<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="genericCompany" value="{{ $genericpacksizesData->genericCompany }}" readonly="" >
				                                </div>
				                              </div>
				                            </div>
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="genericStrengthId" id="genericStrengthId" required >
				                                      <option value="{{ $genericpacksizesData->genericStrengthId }}">{{ $genericpacksizesData->genericStrength }}</option>
			                            ...
			                            <div class="row">
			                            	...
			                            	{{-- <div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="dosageForm" value="{{ $genericpacksizesData->dosageForm }}" readonly="">
				                                </div>
				                              </div>
											</div> --}}
												  ...
												  <div class="col-sm-8">
													<select class="form-control m-bot15" name="dosageFormId" id="dosageFormId" required >
														...
														@foreach($dosageformData->sortBy('dosageForm') as $dosageform)
															<option value="{{ $dosageform->dosageFormId }}" {{ $genericpacksizesData->dosageFormId==$dosageform->dosageFormId? 'selected':'' }} >
															  {{ title_case($dosageform->dosageForm)}}
															</option> 
														@endforeach   
													</select>
												  </div>
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="genericPackSize" value="{{ $genericpacksizesData->genericPackSize }}" name="genericPackSize" required>
				                                </div>
				                              </div>
				                            </div>
			                            ...
			                            <div class="row">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="packTypeId" id="packTypeId" required >
				                                      ...
				                                      @foreach($packTypesData as $packtype)
				                                          <option value="{{ $packtype->packTypeId }}" {{ $genericpacksizesData->packTypeId==$packtype->packTypeId ? 'selected':'' }}>
				                            ...
				                            <div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" step="0.1" class="form-control" id="avgPriceOfOriginator" name="avgPriceOfOriginator"  value="{{ $genericpacksizesData->avgPriceOfOriginator }}">
				                                </div>
				                              </div>
				                            </div>
			                            ...
			                            <div class="row">
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="ptSellingPrice" name="ptSellingPrice" value="{{ $genericpacksizesData->ptSellingPrice }}" >
				                                </div>
				                              </div>
				                            </div>
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="ptMOQ" name="ptMOQ" value="{{ $genericpacksizesData->ptMOQ }}" >
				                                </div>
				                              </div>
				                            </div>
			                            ...
			                            <div class="row">
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="dealerSellingPrice" name="dealerSellingPrice"  value="{{ $genericpacksizesData->dealerSellingPrice }}">
				                                </div>
				                              </div>
				                            </div>
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="dealerMOQ" name="dealerMOQ"  value="{{ $genericpacksizesData->dealerMOQ }}">
				                                </div>
				                              </div>
				                            </div>
			                            ...
			                            <div class="row">
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="vipSellingPrice" name="vipSellingPrice"  value="{{ $genericpacksizesData->vipSellingPrice }}">
				                                </div>
				                              </div>
				                            </div>
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="compPtSellingPrice" name="compPtSellingPrice"  value="{{ $genericpacksizesData->compPtSellingPrice }}">
				                                </div>
				                              </div>
				                            </div>
			                            ...
			                            <div class="row">
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="compPtSellingPriceOld" name="compPtSellingPriceOld"  value="{{ $genericpacksizesData->compPtSellingPriceOld }}">
				                                </div>
				                              </div>
				                            </div>
			                            	...
			                            	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="compLocalSellingPrice" name="compLocalSellingPrice"   value="{{ $genericpacksizesData->compLocalSellingPrice }}">
				                                </div>
				                              </div>
				                            </div>
			                            </div>
			                            ...
			                            <div class="row">
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="availabilityTypeId" id="availabilityTypeId"  required>
				                                  	...
				                                  	<option value="{{ $genericpacksizesData->availabilityTypeId }}">{{ $availabilitytypeData->where('availabilityTypeId', $genericpacksizesData->availabilityTypeId)->pluck('availabilityType')->first() }}</option>
				                            ...
				                            {{-- <div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="number" class="form-control" id="weightGM" name="weightGM" value="{{ $genericpacksizesData->weightGM }}">
				                                </div>
				                              </div>
				                            </div> --}}
			                              ...
			                              <legend>Add Global Market Prices</legend>
			                                ...
			                                <table id="global_market_price_table" width="100%">
			                                    ...
			                                    <tbody>
			                                        ...
			                                        {{-- existing records --}}
			                                        @foreach ($genpacksizeglobalmarketpricesData->where('genericPackSizeId', $genericpacksizesData->genericPackSizeId ) as $genpacksizeglobalmarketprice)
			                                            <tr>
			                                              <td><input type='checkbox' name='record'></td>
			                                              <td>
			                                                <input  class='form-control' type='number' name='genericPackSizeId[]'  value='{{ $genpacksizeglobalmarketprice->genericPackSizeId}}' readonly multiple hidden>
			                                              	
			                                                <input  class='form-control' type='text' name='site[]'  value='{{ $genpacksizeglobalmarketprice->site}}' readonly multiple >
			                                              </td>
			                                              <td>
			                                                <input  class='form-control' type='number' name='price[]'  value='{{ $genpacksizeglobalmarketprice->price}}' readonly multiple >
			                                              </td>
			                              ...
			                              <legend>Add Supplier Generic Prices</legend>
			                                ...
			                                <table id="generic_price_table" width="100%">
			                                    ...
			                                    <tbody>
			                                    	...
			                                    	{{-- existing records --}}
			                                        @foreach ($suppliergenericpricesData->where('genericPackSizeId', $genericpacksizesData->genericPackSizeId ) as $sppliergenericprices)
			                                            <tr>
															<td><input type='checkbox' name='record'></td>
															<td>

																<input  class='form-control' type='number'  name='supplierId[]'  value='{{ $sppliergenericprices->supplierId}}' readonly multiple hidden="">

																<input  class='form-control' type='text'   value='{{ $sppliergenericprices->supplier}}' readonly multiple >
																
															</td>
															<td>                                      		                                              	
																<input  class='form-control' type='number' step="0.1" name='moq[]'  value='{{ $sppliergenericprices->moq}}' readonly multiple >
															</td>
															<td>
																<input  class='form-control' type='number' step="0.1" name='buyingPrice[]'  value='{{ $sppliergenericprices->buyingPrice}}' readonly multiple >
															</td>
															
															<td> 
																<input  class='form-control' type='text' name='buyingDate[]'  readonly multiple value='{{ YmdTodmY($sppliergenericprices->buyingDate)}}'> 
															</td>
															<td> 
																<textarea  class='form-control'   rows='4'   name='note[]'   multiple > {{ $sppliergenericprices->note}}</textarea> 
															</td>
