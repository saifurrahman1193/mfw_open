 ...
 <div class="container text-success"  id="path-section"  style="padding-top: 50px; font-weight: bold;">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('cartQtyUpdate', [ app()->getLocale(), 'cartId'=>Crypt::encrypt($cartData->cartId) ])  }}" >{{ __('header.Cart') }}</a></li>


        <li class="breadcrumb-item active" aria-current="page">{{ __('orderhistory.updateorder') }}</li>
...
<div class="container cart-sec padd-30">
      ...
      <div class="card-title text-center text-success font-weight-bold ">
          <h2>{{ __('orderhistory.updateorder') }}</h2>
          <h4 style="color: black;">( <span style="color: red;">*</span> {{ __('checkout.markedfieldsmandatory') }}  )</h4>
      </div>

      <form class="form-horizontal" id="delivery-form" method="POST"  enctype="multipart/form-data" action="{{ route('customerOrderUpdate', [app()->getLocale(), 'cartId'=>Crypt::encrypt($cartData->cartId) ]) }}"     >
        ...
        <fieldset class="cart-tab " style="padding: 2%;">
          <legend style="border-bottom: none;">{{ __('checkout.deliverydetails') }}</legend>               
                    ...
                    <div class="col-sm-4">
                     ...
                     <div class="btn-group col-sm-8 " >
                          ...
                          <div class="btn-group col-sm-12">
                              <label for="fancy-checkbox-success" class="btn btn-success  col-xs-2 col-sm-1">
                                  <span class="fa fa-check"></span>
                                  <span> </span>
                              </label>
                              <label for="fancy-checkbox-success" class="btn btn-default active  col-xs-10 col-sm-11" style="white-space: normal; text-align: left;">
                ...
                <div class="form-group row col-sm-10 required">
                    ...
                    <div class="col-sm-8">
                        {{-- <input type="text" name="takingFor" value="{{ $cartData->takingFor }}" class="form-control" placeholder="Name"   id="name" required> --}}
                        <textarea id="name" name="takingFor"  class="form-control"      rows="2" required>{{ $cartData->takingFor }}</textarea>
                      </div>
                </div>
                ...
                <div class="form-group row col-sm-10 ">
                    ...
                    <div class="col-sm-8">
                        {{-- <input type="text" name="takingForLocalLang"  value="{{ $cartData->takingForLocalLang }}" class="form-control" placeholder="Name"   id="takingForLocalLang" > --}}
                        <textarea id="takingForLocalLang" name="takingForLocalLang"  class="form-control"      rows="2" >{{ $cartData->takingForLocalLang }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row col-sm-10 required">
                    ...
                    <div class="col-sm-8">
                        <input type="email" name="email" value="{{ $cartData->email }}" class="form-control" placeholder="Email"   id="email" required readonly>
                    </div>
                </div>
                ...
                <div class="form-group row col-sm-10 required">
                    ...
                    <div class="col-sm-8">
                        <div class="col-sm-6">
                            <select class="form-control m-bot15" id="phoneCode" name="phoneCode" required >
                                ...
                                @foreach($countryData->sortBy('country') as $country)
                                    <option value="{{ '+'.$country->phoneCode }}" 
                                        {{ '+'.$country->phoneCode==$cartData->phoneCode ? 'selected' : '' }}
                                      >
                         ...
                         <div class="col-sm-6">
                            <input type="tel" id="phone" type="phone" class="form-control" name="phone" value="{{ $cartData->phone }}" required>
                         </div>
                        {{-- <input type="text" id="phone" name="phone" value="{{ $cartData->phone }}" class="form-control" placeholder="Phone"   required> --}}
                    </div>
                </div>
                ...
                <div class="form-group row col-sm-10 ">
                    ...
                    <div class="col-sm-8">
                        <input type="tel" id="phonenumber2" name="phonenumber2" value="{{ $cartData->phonenumber2 }}" class="form-control"   >
                    </div>
                </div>
                ...
                <div class="form-group row col-sm-10 required">
                    ...
                    <div class="col-sm-8">
                        <textarea id="streethouse" name="streethouse"  class="form-control"    rows="3" required>{{ $cartData->streethouse }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row col-sm-10 ">
                    ...
                    <div class="col-sm-8">
                        <textarea id="streethouseLocalLang" name="streethouseLocalLang"  class="form-control"    rows="3" >{{ $cartData->streethouseLocalLang }}</textarea>
                    </div>
                </div>
                    ...
                    <div class="col-sm-7">
                      <select class="form-control m-bot15" name="countryId" id="countryId" required >
                          ...
                          @foreach($countryData as $country)
                              <option 
                              {{ $country->countryId==$cartData->countryId ? 'selected' : '' }}
                ...
                <div class="form-group row col-sm-10 required">
                    ...
                    <div class="col-sm-8">
                        {{-- <input type="text" id="cityTownDivision" name="city" value="{{ $cartData->city }}" class="form-control" placeholder="City"   required> --}}
                        <textarea id="cityTownDivision" name="city"  class="form-control"    rows="2" required>{{ $cartData->city }}</textarea>
                ...
                <div class="form-group row col-sm-10 ">
                    ...
                    <div class="col-sm-8">
                        {{-- <input type="text" id="cityLocalLang" name="cityLocalLang"  value="{{ $cartData->cityLocalLang }}"  class="form-control" placeholder="City"   > --}}
                        <textarea id="cityLocalLang" name="cityLocalLang"  class="form-control"    rows="2" >{{ $cartData->cityLocalLang }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row col-sm-10 required">
                    ...
                    <div class="col-sm-8">
                        <input type="number" id="postalCode" name="postalCode" value="{{ $cartData->postalCode }}" class="form-control" placeholder="Post Code"   required>
                    </div>
                </div>
                ...
                <div class="form-group row required">
                  ...
                  <div class="col-sm-7">
                    <select class="form-control m-bot15" name="deliveryMethodId" id="deliveryMethodId" required >
                        ...
                        @foreach($deliverypriceData->where('countryId' , $cartData->countryId) as $deliverymethod)
                            <option 
                              
                              {{ $cartData->deliveryMethodId==$deliverymethod->deliveryMethodId ? 'selected' : '' }}
              ...
              <div class="col-sm-10">
                <div class="form-group row ">
                  ...
                  <div class="col-sm-8">
                    ...
                    <div >
                        <ol class="">
                          <li>{{ __('checkout.fee') }} - {{ $cartData->currency }} <span id="deliveryfee"></span></li>
              ...
              <div class="form-group row col-sm-10 {{ ($deliverypriceData->where('countryId' , $cartData->countryId)->where('deliveryMethodId' , $cartData->deliveryMethodId)->pluck('isCommentRequired')->first() )==1 ? 'required' : ''}}"  id="deliveryComment-root-container"  {{ ($deliverypriceData->where('countryId' , $cartData->countryId)->where('deliveryMethodId' , $cartData->deliveryMethodId)->pluck('isCommentApplicable')->first() )==1 ? '' : 'hidden'}}>
                  ...
                  <div class="col-sm-8"   id="deliveryComment-container">
                      <textarea id="deliveryComment" name="deliveryComment" value="" class="form-control" placeholder="{{ __('checkout.deliveryComment') }}"    rows="3"  {{ ($deliverypriceData->where('countryId' , $cartData->countryId)->where('deliveryMethodId' , $cartData->deliveryMethodId)->pluck('isCommentRequired')->first() )==1 ? 'required' : ''}}>{{ $cartData->deliveryComment }}</textarea>
                  </div>
              </div>
                                ...
                                <select class="form-control m-bot15" name="paymentCountryId" id="paymentCountryId" required >
                                    ...
                                    @foreach($countryData as $country)
                                        <option
                                          ...
                                          {{ $country->countryId == $cartData->paymentCountryId ? 'selected' : '' }}
                            ...
                            <div class="form-group row required">
                              ...
                              <div class="col-sm-8">
                                <select class="form-control m-bot15" name="paymentMethodId" id="paymentMethodId" required >
                                    ...
                                    @foreach($paymentpriceData->where('countryId' , $cartData->countryId) as $paymentmethod)
                                        <option 

                                          {{ $paymentmethod->paymentMethodId == $cartData->paymentMethodId ? 'selected' : '' }}

                                         value="{{ $paymentmethod->paymentMethodId }}"
                                            data-paymentmethodid ="{{ $paymentmethod->paymentMethodId }}"
                                            data-iscommentapplicable ="{{ $paymentmethod->isCommentApplicable }}"
                                            data-iscommentrequired ="{{ $paymentmethod->isCommentRequired }}"

                                            data-paymentmethod ="{{ $paymentmethod->paymentMethod }}"
                                            data-transactionfee="{{ $paymentmethod->transactionFee }}"
                                          >
                                          {{ title_case($paymentmethod->paymentMethod) }}
                                        </option> 
                                    @endforeach   
                                </select>
                              </div>
                          ...
                          <div class="col-sm-10">
                              <div class="form-group row ">
                                ...
                                <div class="col-sm-8">
                                  ...
                                  <div >
                                      <ol class="">
                                        <li>{{ __('checkout.fee') }} - {{-- {{ $cartData->currency }} --}}  <span id="paymentfee"></span> %</li>
                            ...
                            <div class="form-group row col-sm-10  {{ ($paymentpriceData->where('countryId' , $cartData->countryId)->where('paymentMethodId' , $cartData->paymentMethodId)->pluck('isCommentRequired')->first() )==1 ? 'required' : ''}}"  id="paymentComment-root-container" {{ ($paymentpriceData->where('countryId' , $cartData->countryId)->where('paymentMethodId' , $cartData->paymentMethodId)->pluck('isCommentApplicable')->first() )==1 ? '' : 'hidden'}} >
                                ...
                                <div class="col-sm-8"   id="paymentComment-container">
                                    <textarea id="paymentComment" name="paymentComment" value="" class="form-control" placeholder="{{ __('checkout.paymentComment') }}"   {{ ($paymentpriceData->where('countryId' , $cartData->countryId)->where('paymentMethodId' , $cartData->paymentMethodId)->pluck('isCommentRequired')->first() )==1 ? 'required' : ''}} rows="3">{{ $cartData->paymentComment }}</textarea>
                                </div>
                            </div>
            ...
            <input type="number"  name="tax"  value="{{ $cartData->tax }}" step="0.1"  hidden>
            <input type="number" id="discount" name="discount"  value="{{ $cartData->discount }}"  step="0.1" hidden>
            <input type="number" id="shippingAmount"  name="shippingAmount"  value="{{ $cartData->shippingAmount }}" step="0.1"  hidden>
            <input type="number" id="totalAmount"  name="totalAmount"  value="{{  $cartData->totalAmount }}" step="0.01"  hidden>
            <input type="number"  name="totalQty"  value="{{ $cartData->totalQty }}" step="0.1"  hidden>
            <input type="number"  name="totalProducts"  value="{{ $cartData->totalProducts }}" step="0.1"  hidden>
            <input type="number" id="subTotalAmount"  name="subTotalAmount"  value="{{ $cartData->subTotalAmount }}" step="0.1"  hidden>
            <input type="number" id="usdToCurrencyRate" name="usdToCurrencyRate"  value="{{ $cartData->usdToCurrencyRate  }}" step="0.1"  hidden>
            <input type="text" id="currencyname" name="currency"  value="{{ $cartData->currency }}"   hidden>
            <input type="number" id="cartWeightGM"  name="cartWeightGM"  value="{{ $cartData->cartWeightGM }}"   hidden>
            
            <input type="number" step="0.01" id="deliveryPriceInitial"  name="deliveryPriceInitial" value="{{ $cartData->deliveryPriceInitial }}"  value=""   hidden>
            <input type="number" step="0.01" id="deliveryPriceIncrement"  name="deliveryPriceIncrement"   value="{{ $cartData->deliveryPriceIncrement }}"    hidden>

            <input type="number" step="0.01" id="transactionFee" name="transactionFee"   value="{{ $cartData->transactionFee }}"  readonly  hidden >
            <input type="number" step="0.01" id="transactionFeeAmount" name="transactionFeeAmount"  value="{{ $cartData->transactionFeeAmount }}"  readonly  hidden >

            <input type="text"  id="offer" name="offer" value="{{ $cartData->offer }}" readonly  hidden >
                      ...
                      <table class="table table-hover table-responsive ">
                            ...
                            <tr>
                              <td>
                                  ...
                                  @elseif (app()->getLocale()=='cn')
                                      {{ $genericbrandData->where('genericBrandId',  $cartdetail->genericBrandId)->pluck('genericBrandCN')->first().' (' }}
                                      {{ $genericpacksizes_with_customer_price_data->where('genericPackSizeId',  $cartdetail->genericPackSizeId)->pluck('genericStrengthCN')->first().' )' }}
                                  @elseif (app()->getLocale()=='ru')
                                      {{ $genericbrandData->where('genericBrandId',  $cartdetail->genericBrandId)->pluck('genericBrandRU')->first().' (' }}
                                      {{ $genericpacksizes_with_customer_price_data->where('genericPackSizeId',  $cartdetail->genericPackSizeId)->pluck('genericStrengthRU')->first().' )' }}
                                  @endif
                              </td>
                              <td>{{ $cartdetail->qty }}</td>
                              <td>{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  {{ ($cartdetail->price * $cartData->usdToCurrencyRate ) * $cartdetail->qty }}</td>
                            </tr>
                          @endforeach
                        </tbody>
                        <tfoot class="text-success">
                          ...
                          <tr>
                            ...
                            <th>{{ $cartData->totalQty }}</th>
                            <th>{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  {{ $cartData->subTotalAmount}}</th>
                          </tr>
                          <tr>
                            <th>{{ __('checkout.discount') }}</th>
                            <td></td>
                            <td>{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  {{ $cartData->discount }}</td>
                          </tr>
                          <tr>
                            <th>{{ __('checkout.tax') }}</th>
                            <td></td>
                            <td>{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  {{ $cartData->tax }}</td>
                          </tr>
                          <tr>
                            <th>{{ __('checkout.shippingcost') }}</th>
                            <td></td>
                            <td >{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  <span id="cartShippingCostSpan">{{ $cartData->shippingAmount }}</span> </td>
                          </tr>

                          <tr>
                            <th>{{ __('checkout.transactionFee') }}</th>
                            <td></td>
                            <td >{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  <span id="transactionAmountSpan">{{ $cartData->transactionFeeAmount }}</span> </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td></td>
                            <th >{!! $countryData->where('currency', $cartData->currency)->pluck('hexcode')->first() !!}  <span id="cartTotalSpan">{{ $cartData->totalAmount }}</span> </th>
                          </tr>
                  ...
                  <table class="table table-hover table-responsive ">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{ $cartData->phoneCode.$cartData->phone }}</td>
                            </tr>
                        </tbody>
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="invalidCheck2" style="color: red;">
                  ...
                  <u><a href="{{ app()->getLocale()?action('PageController@dynamicPageFront', array(app()->getLocale(),1 ) ) : action('PageController@dynamicPageFront', array(app()->getLocale(),1 ) ) }}" target="_blank" style="padding: 0 px; color: red !important; float: none;">{{  __('checkout.termsconditions')}}</a></u>
                   ...
                   <u><a href="{{ app()->getLocale()?action('PageController@dynamicPageFront', array(app()->getLocale(),7 ) ) : action('PageController@dynamicPageFront', array(app()->getLocale(),7 ) ) }}" target="_blank" style="padding: 0 px; color: red !important; float: none;">{{ __('checkout.privacypolciy') }}</a></u>
                </label>
              </div>
            </div>
        ...
        <div class="row col-md-12">
          <div class="col-md-6"  style="padding: 25px;" >
            {{-- <a href="{{ app()->getLocale()?action('ProductController_F@productlistPage' , array(0  ) ) : action('ProductController_F@productlistPage',  array(0  ) ) }}" class="next shp-btn pull-left" style="border-radius: 50px; text-transform: uppercase; border: 2px solid #25bb2b;  font-weight: 700;  padding: 12px 40px;  background-color: #25bb2b;  color: white !important;">
            {{ __('cart.continuepurchasing') }}</a> --}}
          </div>


          <div class="col-md-6 ">
              <input type="submit" name="" value="{{ __('checkout.confirm') }}" class="pull-right" style="margin-top: 25px;">
          </div>
...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      // ==============loading default delivery data===========
            var name = '{{ $cartData->takingFor }}';
            var email = '{{ $cartData->email }}';
            var phoneCode = '{{ $cartData->phoneCode }}';
            var phone = '{{ $cartData->phone }}';
            var streethouse = '{{ $cartData->streethouse }}';
            var cityTownDivision = '{{ $cartData->city }}';
            var postalCode = '{{ $cartData->postalCode }}';
            var countryId = '{{ $cartData->countryId }}';
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('select[name="deliveryMethodId"]').on('change', function(){
        ...
        if(deliveryMethodId) {
            $.ajax({
                url: '/{{ app()->getLocale() }}/getDeliverySummary2/'+deliveryMethodId+'/'+countryId+'/'+cartId+'/'+currency,
                type:"GET",
                dataType:"json",
                beforeSend: function(){
                    $('#loader').css("visibility", "visible");
                ...
                success:function(data) {
                    ...
                    // console.log(data);
                    // console.log(data.data);
                    console.log('data.cartshippingCostWeightForDeliverySummary = '+ data.cartshippingCostWeightForDeliverySummary);
        ...
        if(paymentMethodId) {
            $.ajax({
                ...
                success:function(data) {
                    ...
                    $('#paymentfee').text(data.transactionFee);
                    $('#transactionFee').attr('value',data.transactionFee);
  ...
  $(document).ready(function() {
    ...
    $('select').on('change', function(){
        ...
        if(deliveryMethodId>0 && countryId>0 && paymentMethodId>0 && paymentCountryId>0) {
            $.ajax({
                url: '/{{ app()->getLocale() }}/getCheckoutCalculation2/'+deliveryMethodId+'/'+countryId+'/'+paymentMethodId+'/'+paymentCountryId+'/'+cartId+'/'+currency,
                type:"GET",
                dataType:"json",
                beforeSend: function(){
                    $('#loader').css("visibility", "visible");
                ...
                success:function(data) {
                    ...
                    $('#discount').attr('value',data.cartdiscount * data.usdToCurrencyRate);
                    $('#shippingAmount').attr('value',(data.shippingCost * data.usdToCurrencyRate).toFixed(2));
                    $('#totalAmount').attr('value',(data.cartTotal));
                    $('#subTotalAmount').attr('value',data.cartsubtotal * data.usdToCurrencyRate);
                    $('#usdToCurrencyRate').attr('value',data.usdToCurrencyRate);
                     $('#currencyname').attr('value','{!! $cartData->currency !!}'); 
                    $('#cartWeightGM').attr('value',data.cartWeight);

                    $('#deliveryPriceInitial').attr('value',data.deliveryPriceInitial * data.usdToCurrencyRate);
                    $('#deliveryPriceIncrement').attr('value',data.deliveryPriceIncrement * data.usdToCurrencyRate);
                    $('#transactionFeeAmount').attr('value', (data.transactionAmount ).toFixed(2));


                    $('#offer').attr('value',data.offer);
...
<div class="container" style="z-index: 10000000000000000000000">
    <div class="row">
        {{-- <a class="btn btn-primary" data-toggle="modal" href="#cartUpdateModal">open Popup</a> --}}
        <div class="modal fade" id="cartUpdateModal" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="thank-you-pop">
                          ...
                          <p>{{__('modals.orderupdatemsg')}}</p>
                          {{-- <h3 class="cupon-pop">Your Order Id: <span>@if (session('orderId'))
