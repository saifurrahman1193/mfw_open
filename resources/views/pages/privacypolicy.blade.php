...
@section('pageTitle', 'Edit Page Privacy Policy')
...
<div class="content-wrapper" style="min-height: 0px;">
		...
		<div class="card col-md-12">
			<div class="card-body">
		        <h4 class="card-title" style="text-align: center;">Privacy Policy</h4>
			        ...
			        <div class="col-md-12 col-md-offset-2">
			            <div class="panel panel-default">
			                ...
			                <div class="panel-body">
			                    <form class="form-horizontal"  method="post" enctype="multipart/form-data" action="{{ route('privacypolicyPageUpdate') }}"  onsubmit="return confirm('Do you really want to proceed?');">
					                          {{method_field('put')}}
					                          {{ csrf_field() }}
					                            ...
					                            <div class="col-md-12">
					                              <div class="form-group row required">
					                                ...
					                                <div class="col-sm-8">
					                                  <textarea class="form-control "  rows="4" id="pageDesc" name="pageDesc"  contenteditable="false" required>{{ $pageData->pageDesc }} </textarea>
					                            ...
					                            <div class="col-md-12">
					                              <div class="form-group row ">
					                                ...
					                                <div class="col-sm-8">
					                                  <textarea class="form-control " rows="4" id="pageDescCN" name="pageDescCN" >{{ $pageData->pageDescCN }} </textarea>
					                            ...
					                            <div class="col-md-12">
					                              <div class="form-group row ">
					                                ...
					                                <div class="col-sm-8">
					                                  <textarea class="form-control " rows="4" id="pageDescRU" name="pageDescRU" >{{ $pageData->pageDescRU }} </textarea>
					                                </div>
					                              </div>
					                            </div>
