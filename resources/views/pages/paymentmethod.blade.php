...
@section('pageTitle', 'Edit Page Payment Method')
...
<div class="content-wrapper" style="min-height: 0px;">
		...
		<div class="card col-md-12">
			<div class="card-body">
		        <h4 class="card-title" style="text-align: center;">Payment Method</h4>
			        ...
			        <div class="col-md-12 col-md-offset-2">
			            <div class="panel panel-default">
			                ...
			                <div class="panel-body">
			                    <form class="form-horizontal"  method="post" enctype="multipart/form-data" action="{{ route('paymentmethodPageUpdate') }}"  onsubmit="return confirm('Do you really want to proceed?');">
					                          {{method_field('put')}}
					                          {{ csrf_field() }}
