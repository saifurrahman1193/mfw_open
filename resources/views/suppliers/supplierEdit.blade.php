  ...
  fieldset{
   ...
   padding: 8px;
	...
	{{-- <div class="container"> --}}
		...
		<div class="card-body">
        <h4 class="card-title" style="text-align: center;">Edit Supplier</h4>
	        ...
	        <div class="col-md-12 col-md-offset-2">
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <form class="form-horizontal" method="POST"  enctype="multipart/form-data" action="{{ route('supplier.settings.supplier.update', $supplierData->supplierId) }}"  onsubmit="return confirm('Do you really want to proceed?');"   >
	                    	{{method_field('put')}}
			                {{ csrf_field() }}
			                        	...
			                        	<div class="row">
				                            ...
				                            <div class="col-md-6">
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="supplier" name="supplier" required value="{{ $supplierData->supplier }}">
				                                </div>
				                              </div>
				                            </div>
				                            ...
				                            <div class="col-md-6">
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="phone" name="phone" required value="{{ $supplierData->phone }}">
				                                </div>
				                              </div>
				                            </div>
			                        	...
			                        	<div class="row">
				                            ...
				                            <div class="col-md-6">
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="email" class="form-control" id="email" name="email" required value="{{ $supplierData->email }}">
				                                </div>
				                              </div>
				                            </div>
				                            ...
				                            <div class="col-md-6">
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="address" name="address" required  value="{{ $supplierData->address }}">
				                                </div>
				                              </div>
				                            </div>
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="countryId" id="countryId" required >
				                                      <option value="{{ $supplierData->countryId }}">{{ $supplierData->country }}</option>
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="genericCompanyId" id="genericCompanyId" required >
				                                      <option value="{{ $supplierData->genericCompanyId }}">{{ $supplierData->genericCompany }}</option>
			                        	...
			                        	<div class="row">
				                              ...
				                              <div class="form-group row required">
				                                ...
				                                <div class="col-sm-8">
				                                  <select class="form-control m-bot15" name="positionId" id="positionId" required >
				                                      <option value="{{ $supplierData->positionId }}">{{ $supplierData->position }}</option>
				                        	...
				                        	<div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="thirdPartyCompany" name="thirdPartyCompany" value="{{ $supplierData->thirdPartyCompany }}">
				                                </div>
				                              </div>
				                            </div>
			                        	...
			                        	<div class="row">
				                            ...
				                            <div class="col-md-6">
				                              <div class="form-group row ">
				                                ...
				                                <div class="col-sm-8">
				                                  <textarea name="comment" id="comment" class="form-control" rows="3">{{ $supplierData->comment }}</textarea>
				                                </div>
				                              </div>
				                            </div>
			                              ...
			                              <legend>Add Social Media</legend>
			                                ...
			                                <table id="social_media_table" width="100%">
			                                    ...
			                                    <tbody>
			                                    	...
			                                    	{{-- existing records --}}
			                                        @foreach ($suppliersocialmediaData as $suppliersocialmedia)
			                                            <tr>
			                                              <td><input type='checkbox' name='record'></td>
			                                              <td>

			                                              	<input  class='form-control' type='number'  name='socialMediaId[]'  value='{{ $suppliersocialmedia->socialMediaId}}' readonly multiple hidden="">

			                                              	<input  class='form-control' type='text'   value='{{ $suppliersocialmedia->socialMedia}}' readonly multiple >
			                                              	
			                                              </td>
			                                              
			                                              <td>
			                                                <input  class='form-control' type='text'  name='supplierSocialNameOrId[]'  value='{{ $suppliersocialmedia->supplierSocialNameOrId}}' readonly multiple >
			                                              </td>
