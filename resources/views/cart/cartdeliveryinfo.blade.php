...
@section('pageTitle', 'Cart Delivery Info')
...
<div class="content-wrapper" style="min-height: 0px;">
    ...
    <div class="card">
        <div class="card-title mt-4">
                <h4 class="text-center mt-2">Cart Delivery Information</h4>
        </div>
        <div class="card-body">
            <ul class="list-group">
            ...
            <table class="table table-bordered table-hover" >
                <tbody>
                    ...
                    @foreach ($cartdeliveryinfoData->sortByDesc('created_at') as $cartdeliveryinfo)
                        <tr>
                            <td>
                                <ul class="list-group">
            ...
            <form class="form-horizontal" method="POST"  enctype="multipart/form-data" action="{{ route('cartDeliveryInfoUpdate', Request('cartId')) }}"  onsubmit="return confirm('Do you really want to proceed?');"   >
                {{ csrf_field() }}
                    ...
                    <div class="col-md-12">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                <textarea id="messageCN" name="messageCN"  rows="5" class="form-control" ></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group row required">
                            ...
                            <div class="col-sm-8">
                                <textarea id="messageRU" name="messageRU"  rows="5" class="form-control" ></textarea>
                            </div>
                        </div>
                    </div>
